...
DATASET_ID="${DATASET_ID:-14}"
DATASET_NAME="${DATASET_NAME:-Dataset014_ThoracicOAR_Dataset004Split}"
...
LOG_ROOT="${LOG_ROOT:-${PROJECT_ROOT}/logs/nnunet_dataset014_oar_${CONFIG}}"
MPLCONFIGDIR="${MPLCONFIGDIR:-/tmp/mpl_nnunet_dataset014}"
